ej.addCulture( "fa-IR", {
	...
	calendars: {
		standard: {
			...
			months: {
				names: ["ژانويه","فوريه","مارس","آوريل","مِی ","جون ","جولای ","آگَست","سپتامبر","اُكتبر","نوامبر","دِسامبر ",""],
				namesAbbr: ["ژانويه","فوريه","مارس","آوريل","مِی ","جون ","جولای ","آگَست","سپتامبر","اُكتبر","نوامبر","دِسامبر ",""]
			},
			AM: ["ق.ظ","ق.ظ","ق.ظ"],
			PM: ["ب.ظ","ب.ظ","ب.ظ"],
			patterns: {
