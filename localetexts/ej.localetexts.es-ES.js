...
ej.ExcelFilter.Locale["es-ES"] = {
    ...
    StringMenuOptions: [{ text: "Igual", value: "igual" }, { text: "No es igual", value: "no es igual" }, { text: "Comienza con", value: "comienza con" }, { text: "Termina con", value: "termina con" }, { text: "contiene", value: "contiene" }, { text: "Filtro personalizado", value: "filtro personalizado" }, ],
    NumberMenuOptions: [{ text: "Igual", value: "igual" }, { text: "No es igual", value: "no es igual" }, { text: "Menos que", value: "menos que" }, { text: "Menor o igual", value: "menor o igual" }, { text: "Mas grande que", value: "mas grande que" }, { text: "Mayor que o igual", value: "mayor que o igual" }, { text: "Entre", value: "Entre" }, { text: "Filtro personalizado", value: "filtro personalizado" }, ],
    GuidMenuOptions: [{ text: "Igual", value: "igual" }, { text: "No es igual", value: "no es igual" }, { text: "Filtro personalizado", value: "filtro personalizado" }, ],
    DateMenuOptions: [{ text: "Igual", value: "igual" }, { text: "No es igual", value: "no es igual" }, { text: "Menos que", value: "menos que" }, { text: "Menor o igual", value: "menor o igual" }, { text: "Mas grande que", value: "mas grande que" }, { text: "Mayor que o igual", value: "mayor que o igual" }, { text: "Entre", value: "Entre" }, { text: "Filtro personalizado", value: "filtro personalizado" }, ],
    Top10MenuOptions: [{ text: "Parte superior", value: "parte superior" }, { text: "Fondo", value: "fondo" }, ],
...
ej.Grid.Locale["es-ES"] = {
    ...
    StringMenuOptions: [{ text: "Comienza con", value: "Comienza con" }, { text: "Termina con", value: "Termina con" }, { text: "contiene", value: "contiene" }, { text: "Igual", value: "Igual" }, { text: "No es igual", value: "No es igual" }, ],
    NumberMenuOptions: [{ text: "Menos que", value: "Menos que" }, { text: "Mas grande que", value: "Mas grande que" }, { text: "Menor o igual", value: "Menor o igual" }, { text: "Mayor que o igual", value: "Mayor que o igual" }, { text: "Igual", value: "Igual" }, { text: "No es igual", value: "No es igual" }, ],
    PredicateAnd: "Y",
    PredicateOr: "O",
    Filter: "Filtrar",
...
ej.PdfViewer.Locale["es-ES"] = {
    toolbar: {
        ...
        fittopage: {
            ...
            pageWidth: "Ajuste ancho",
            pageHeight: "Ajustar a la página"
        },
    },
};
...
ej.PivotGrid.Locale["es-ES"] = {
    ...
    DragFieldHere: "Arrastre los campos aquí",
...
ej.Spreadsheet.Locale["es-ES"] = {
    ...
    DateEnd: "Fecha final:",
    ListStart: "Fuente:",
    FreeText: "Mostrar alerta de error después de introducir datos no válidos,",
    ...
    LineTrTitle: "Que atraviesa (Ctrl + L)",
    ...
    PasswordAlert2: "Por favor, introduzca una contraseña.",
