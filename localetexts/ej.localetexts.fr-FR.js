...
ej.ExcelFilter.Locale["fr-FR"] = {
    ...
    StringMenuOptions: [{ text: "Égal", value: "égal" }, { text: "Inégal", value: "inégal" }, { text: "Commence avec", value: "commence avec" }, { text: "Se termine par", value: "se termine par" }, { text: "contient", value: "contient" }, { text: "Filtre personnalisé", value: "filtre personnalisé" }, ],
    NumberMenuOptions: [{ text: "Égal", value: "égal" }, { text: "Inégal", value: "inégal" }, { text: "Moins que", value: "moins que" }, { text: "Inférieur ou égal", value: "inférieur ou égal" }, { text: "Plus grand que", value: "plus grand que" }, { text: "Meilleur que ou égal", value: "Meilleur que ou égal" }, { text: "Entre", value: "entre" }, { text: "Filtre personnalisé", value: "filtre personnalisé" }, ],
    GuidMenuOptions: [{ text: "Égal", value: "égal" }, { text: "Inégal", value: "inégal" }, { text: "Filtre personnalisé", value: "filtre personnalisé" }, ],
    DateMenuOptions: [{ text: "Égal", value: "égal" }, { text: "Inégal", value: "inégal" }, { text: "Moins que", value: "moins que" }, { text: "Inférieur ou égal", value: "inférieur ou égal" }, { text: "Plus grand que", value: "plus grand que" }, { text: "Meilleur que ou égal", value: "Meilleur que ou égal" }, { text: "Entre", value: "entre" }, { text: "Filtre personnalisé", value: "filtre personnalisé" }, ],
    Top10MenuOptions: [{ text: "Haut", value: "haut" }, { text: "Bas", value: "bas" }, ],
...
ej.Grid.Locale["fr-FR"] = {
    ...
    StringMenuOptions: [{ text: "Commence avec", value: "Commence avec" }, { text: "Se termine par", value: "Se termine par" }, { text: "contient", value: "contient" }, { text: "Égal", value: "Égal" }, { text: "Inégal", value: "Inégal" }, ],
    NumberMenuOptions: [{ text: "Moins que", value: "Moins que" }, { text: "Plus grand que", value: "Plus grand que" }, { text: "Inférieur ou égal", value: "Inférieur ou égal" }, { text: "Meilleur que ou égal", value: "Meilleur que ou égal" }, { text: "Égal", value: "Égal" }, { text: "Inégal", value: "Inégal" }, ],
    PredicateAnd: "ET",
    PredicateOr: "OU",
    Filter: "Filtre",
