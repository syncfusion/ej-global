...
ej.ExcelFilter.Locale["vi-VN"] = {
    ...
    StringMenuOptions: [{ text: "bằng", value: "bằng" }, { text: "Không công bằng", value: "không công bằng" }, { text: "Bắt đầu với", value: "bắt đầu với" }, { text: "Kết thúc Với", value: "endswith" }, { text: "Chứa đựng", value: "chứa đựng" }, { text: "bộ lọc tùy chỉnh", value: "bộ lọc tùy chỉnh" }, ],
    NumberMenuOptions: [{ text: "bằng", value: "bằng" }, { text: "Không công bằng", value: "không công bằng" }, { text: "Ít hơn", value: "ít hơn" }, { text: "Less Than Hoặc bình đẳng", value: "nhỏ hơn hoặc bằng" }, { text: "Lớn hơn", value: "lớn hơn" }, { text: "Lớn hơn hoặc bằng", value: "lớn hơn hoặc bằng" }, { text: "Giữa", value: "giữa" }, { text: "bộ lọc tùy chỉnh", value: "bộ lọc tùy chỉnh" }, ],
    GuidMenuOptions: [{ text: "bằng", value: "bằng" }, { text: "Không công bằng", value: "không công bằng" }, { text: "bộ lọc tùy chỉnh", value: "bộ lọc tùy chỉnh" }, ],
    DateMenuOptions: [{ text: "bằng", value: "bằng" }, { text: "Không công bằng", value: "không công bằng" }, { text: "Ít hơn", value: "ít hơn" }, { text: "Less Than Hoặc bình đẳng", value: "nhỏ hơn hoặc bằng" }, { text: "Lớn hơn", value: "lớn hơn" }, { text: "Lớn hơn hoặc bằng", value: "lớn hơn hoặc bằng" }, { text: "Giữa", value: "giữa" }, { text: "bộ lọc tùy chỉnh", value: "bộ lọc tùy chỉnh" }, ],
    Top10MenuOptions: [{ text: "Hàng đầu", value: "hàng đầu" }, { text: "đáy", value: "đáy" }, ],
...
ej.Grid.Locale["vi-VN"] = {
    ...
    StringMenuOptions: [{ text: "Bắt đầu với", value: "Bắt đầu với" }, { text: "EndsWith", value: "EndsWith" }, { text: "Chứa đựng", value: "Chứa đựng" }, { text: "bằng", value: "bằng" }, { text: "Không công bằng", value: "Không công bằng" }, ],
    NumberMenuOptions: [{ text: "Ít hơn", value: "Ít hơn" }, { text: "Lớn hơn", value: "Lớn hơn" }, { text: "Less Than Hoặc bình đẳng", value: "Less Than Hoặc bình đẳng" }, { text: "Lớn hơn hoặc bằng", value: "Lớn hơn hoặc bằng" }, { text: "bằng", value: "bằng" }, { text: "Không công bằng", value: "Không công bằng" }, ],
    PredicateAnd: "VÀ",
    PredicateOr: "HOẶC LÀ",
    Filter: "Lọc",
...
ej.olap.OlapClient.Locale["vi-VN"] = {
    ...
    Sorting: "Phân loại",
    Measure: "<U> M </ u> biện pháp",
    Order: "Gọi món",
    Filtering: "lọc",
    Condition: "C <u> o </ u> ndition",
    PreserveHierarchy: "P <u> r </ u> eserve Hierarchy",
    Ascending: "<U> A </ u> tăng dần",
    Descending: "D <u> e </ u> tăng dần",
    Enable: "E <u> n </ u> thể",
...
ej.Spreadsheet.Locale["vi-VN"] = {
	...
	NewSheet: "Tờ New",
	FullSheetCopyPasteAlert: "We cant paste because the Copy area and paste area arent the same size.",
	Heading: "tiêu đề",
